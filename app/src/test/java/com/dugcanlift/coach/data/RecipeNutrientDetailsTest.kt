...
class RecipeNutrientDetailsTest {
    ...
    @Test fun `the iOS fixture's sugar and sodium are fields now and survive a backup round trip`() {
        ...
        val again = BackupCodec.restore(BackupCodec.export(r.clients, r.preservedLibrary, r.recipes, r.meals, r.routines, r.sessions, emptyMap(), emptyList()))
    ...
    @Test fun `day totals and itemised details round trip through a backup under their documented names`() {
        ...
        val json = JSONObject(BackupCodec.export(listOf(client), null, emptyList(), emptyList(), emptyList(), emptyList(), emptyMap(), emptyList()))
